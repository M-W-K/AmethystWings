...
public class AmethystWingsItemsRegistry {
    ...
    public static final RegistryObject<Item> RESONANT_AMETHYST = ITEMS.register("resonant_amethyst",
            () -> new WingsCrystalItem(new Item.Properties().durability(60), (byte) 0, () -> (byte) AmethystWingsConfig.resonantMass, () -> AmethystWingsConfig.resonantToughness, RESONANT, ELYTRA, SHIELD, BOOST));
    public static final RegistryObject<Item> HARDENED_AMETHYST = ITEMS.register("hardened_amethyst",
            () -> new WingsCrystalItem(new Item.Properties().durability(150), (byte) 10, () -> (byte) AmethystWingsConfig.hardenedMass, HARDENED, SHIELD));
    ...
    public static final RegistryObject<Item> AURIC_AMETHYST = ITEMS.register("auric_amethyst",
            () -> new WingsCrystalItem(new Item.Properties().stacksTo(1).fireResistant(), (byte) 0, (byte) 5, () -> AmethystWingsConfig.auricToughness, AURIC, NONE));
}
